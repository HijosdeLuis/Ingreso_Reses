...
Public Class RptReporteIngresos
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Ingreso_Carne.RptReporteIngresos.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRptReporteIngresos
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As RptReporteIngresos = New RptReporteIngresos()
        rpt.Site = Me.Site
        Return rpt
    End Function
