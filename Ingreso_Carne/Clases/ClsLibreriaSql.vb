...
Public Class ClsLibreriaSql
    ...
    Public Sub Consulta(strsql As String, ByRef ts As DataTable, Transa As SqlTransaction, ByRef resultado As Boolean, ByRef mensaje As String)
